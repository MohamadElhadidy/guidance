							...
							<div class="slider_demo2">
								<div class="single_post post_type6 xs-mb30">
									...
									<div class="single_post_text">
										...
										<h4><a href="video_post1.html">Japan’s virus success has puzzled the world. Is its luck running out?</a></h4>
								...
								<div class="single_post post_type6 xs-mb30">
									...
									<div class="single_post_text">
										...
										<h4><a href="video_post1.html">Copa America: Luis Suarez from devastated US America</a></h4>
										<div class="space-10"></div>
										<p class="post-p">The property, complete with 30-seat screening from room, a 100-seat amphitheater and a swimming pond with sandy shower…</p>
									</div>
								</div>
					...
					<div class="col-lg-8">
						<div class="single_post post_type3 post_type11 margintop-60- xs-mb30">
							...
							<div class="single_post_text padding30 dark-2">
								...
								<h4><a href="post1.html">Copa America: Luis Suarez from devastated US Suarez from devastated US</a></h4>
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						...
						<div class="col-lg-6 col-lg-12">
							...
							<div class="widget upcomming_macth mb30">
								...
								<div class="single_post post_type13 widgets_small">
									...
									<div class="single_post_text">	<a href="#" class="playing_teams">Germany <span>VS &nbsp;</span>France</a>
								...
								<div class="single_post post_type13 widgets_small">
									...
									<div class="single_post_text">	<a href="#" class="playing_teams">Spain <span>VS &nbsp;</span>Portugal</a>
										<p class="meta macth_meta">Tomorrow &nbsp;|&nbsp;<span> M22:30 (CST) </span> &nbsp;</p>
									</div>
									<div class="circle_match_time">
								...
								<div class="single_post post_type13 widgets_small">
									...
									<div class="single_post_text">	<a href="#" class="playing_teams">Russia <span>VS &nbsp;</span>Italy</a>
										<p class="meta macth_meta">Tomorrow &nbsp;|&nbsp;<span> M22:30 (CST) </span> &nbsp;</p>
									</div>
									<div class="circle_match_time">
								...
								<div class="single_post post_type13 widgets_small">
									...
									<div class="single_post_text">	<a href="#" class="playing_teams">Croatia <span>VS &nbsp;</span>England</a>
										<p class="meta macth_meta">Tomorrow &nbsp;|&nbsp;<span> M22:30 (CST) </span> &nbsp;</p>
									</div>
									<div class="circle_match_time">
						...
						<div class="col-lg-6 col-lg-12">
							<div class="widget category mb30">
								<div class="row">
									...
									<div class="col-6 text-right align-self-center">	<a href="#" class="see_all">See All</a>
									</div>
								</div>
								<ul>
									<li>
									...
									<li>
										<a href="#" style="background: url(../assets/img/categories/category2.jpg);">	<span>Entertainment</span>
											<img src="../assets/img/icon/union.png" alt="">
										</a>
									</li>
									<li>
										<a href="#" style="background: url(../assets/img/categories/category3.jpg);">	<span>Financial</span>
											<img src="../assets/img/icon/union.png" alt="">
										</a>
									</li>
									<li>
										<a href="#" style="background: url(../assets/img/categories/category4.jpg);">	<span>Business</span>
											<img src="../assets/img/icon/union.png" alt="">
										</a>
									</li>
									<li>
										<a href="#" style="background: url(../assets/img/categories/category4.jpg);">	<span>Scientists</span>
											<img src="../assets/img/icon/union.png" alt="">
										</a>
									</li>
									<li>
										<a href="#" style="background: url(../assets/img/categories/category6.jpg);">	<span>International’s</span>
											<img src="../assets/img/icon/union.png" alt="">
										</a>
									</li>
								</ul>
